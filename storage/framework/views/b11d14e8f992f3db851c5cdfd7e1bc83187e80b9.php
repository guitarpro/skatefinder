...
<div class="jumbotron">
	...
	<div class="container">
        ...
        <?php if(auth()->guard()->guest()): ?>
            <p><a class="btn btn-primary btn-lg" href="<?php echo e(route('login')); ?>" role="button">Log In &raquo;</a>
            <a class="btn btn-primary btn-lg" href="<?php echo e(route('register')); ?>" role="button">Sign Up &raquo;</a>
            </p>
        <?php else: ?>
            <p><a class="btn btn-primary btn-lg" href="<?php echo e(route('home')); ?>" role="button">Go To Dashboard &raquo;</a></p>
        <?php endif; ?>
	</div>
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <p>Create an account with us to find the best skatespots near you! Or upload some of your favorite spots to get the word out to fellow skaters.</p>
              <?php if(auth()->guard()->guest()): ?>
            <p><a class="btn btn-secondary" href="<?php echo e(route('login')); ?>" role="button">View details &raquo;</a></p>
              <?php else: ?>
              <p><a class="btn btn-secondary" href="<?php echo e(route('explore')); ?>" role="button">View details &raquo;</a></p>
              <?php endif; ?>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            ...
            <p><a class="btn btn-secondary" href="<?php echo e(route('products')); ?>" role="button">View details &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            ...
            <p><a class="btn btn-secondary" href="<?php echo e(route('register')); ?>" role="button">View details &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
</div>
